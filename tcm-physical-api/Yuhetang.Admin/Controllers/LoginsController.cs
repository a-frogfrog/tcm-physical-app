...
namespace Yuhetang.Admin.Controllers
{
    public class LoginsController : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> Customer_Logins(Login_Request_Dto dto)
        {
            dto.code = Config.GUID();
            var result = await _logins_Service.Customer_Logins(dto);
        ...
        /// <returns></returns>
        [HttpGet]
        public IActionResult Customer_Check_Login()
        {
