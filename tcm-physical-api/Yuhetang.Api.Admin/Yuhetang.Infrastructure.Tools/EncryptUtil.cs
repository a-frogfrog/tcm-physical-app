...
namespace Yuhetang.Infrastructure.Tools
{
    public static class EncryptUtil
    {
        ...
        /// <returns></returns>
        public static string LoginMd5(this string s, string key)
        {
            return Md532(s, key).Substring(1, 30);
        }
        ...
        public static string EnCookie(this string s, int action = 1)
        {
            string str = "";
            switch (action)
            {
                case 1:
                    ...
                    {
                        if (temp == 15) {
                            str += list[random.Next(0, list.Count)];
                        }
                        str += item + list[random.Next(0, list.Count)];
                        temp++;
                    }
                    break;
            }
        ...
        /// <returns></returns>
        public static string DeCookie(this string s,int action=1) {
            string str = "";
            switch (action) {
                case 1:
                    int temp = 0;
