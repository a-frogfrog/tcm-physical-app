  ...
  return (
    <label className='relative inline-flex items-center'>
      ...
      <svg
        ...
        className='absolute left-[9.1px] h-[4.2px] w-[4.2px] fill-white peer-checked:opacity-60'>
      ...
      <svg
        ...
        id='Layer_1'
        xmlns='http://www.w3.org/2000/svg'
        className='absolute right-[9.1px] h-[4.2px] w-[4.2px] fill-black opacity-60 peer-checked:fill-white peer-checked:opacity-70'>
